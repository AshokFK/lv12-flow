<div>
    <flux:modal name="create-lokasi" variant="flyout">
        <form wire:submit.prevent="save" method="post" class="space-y-6">
            <div>
                <flux:heading size="lg">Tambah lokasi</flux:heading>
                <flux:text class="mt-2">Isikan data yang diperlukan untuk menambah lokasi baru.</flux:text>
            </div>
